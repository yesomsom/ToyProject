...
// MFCdrawingDoc.cpp: CMFCdrawingDoc 클래스의 구현
//
...
// CMFCdrawingDoc 생성/소멸

CMFCdrawingDoc::CMFCdrawingDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CMFCdrawingDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCdrawingDoc::InitializeSearchContent()
{
...
void CMFCdrawingDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
