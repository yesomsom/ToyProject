      ...
      <div class="inner">
         ...
         <form action="register/insert.do" id="registerForm" method="post" >
            ...
            <div class="form-wrapper">
           		<!-- 비밀번호 입력칸 -->
               <input type="password" name="password" placeholder="비밀번호" id="password" class="form-control">
            ...
            <div class="form-wrapper">
            	<!-- 이름 입력칸 -->
               <input name="name" type="text" id="name" placeholder="이름" class="form-control">
               <i class="zmdi zmdi-account-box"></i>
            </div>

            <div class="form-wrapper phone_num">
            	<!-- 휴대폰 번호 입력칸 -->
               <input type="text" name="phone" placeholder="휴대폰번호" class="form-control" id="phone" readonly>
