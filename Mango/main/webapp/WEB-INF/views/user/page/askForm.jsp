				...
				<table>
					<tbody>
						...
						<tr>
							...
							</select> <select title="문의내용 종류" name="ask_catDetail" class="selBox">
						...
						<tr>
							...
							<td><input type="radio" name="rdo00" id="rdo01" checked>
								<label for="rdo01" class="rdoT1">영화관문의</label> <span> <select
									name="ask_type" id="ask_type" class="selBox"
						...
						<tr>
							...
							<td><input type="text" name="ask_subject" class="textBox"
						...
						<div>
							...
							<tr>
								...
								<td><input type="text" name="ask_name"
									placeholder="성명을 입력해 주세요" required></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="email" name="ask_email"
									placeholder="이메일을 입력해 주세요" required> <span>답변
       ...
       다만, 수집에 동의하지 않을 경우 서비스 이용이 제한됩니다.
					...
					<div class="btn_A">
						<input class="btn1" type="reset" value="다시 쓰기"> <input
							class="btn2" type="submit" value="확인">
					</div>
				</div>
			</div>
	</div>
