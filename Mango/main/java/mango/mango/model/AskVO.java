...
@Setter
public class AskVO {
   private int askId;      //글 고유 id
   private int askNum;      //글 번호
   ...
   private int askCat;    //질문 카테고리
   private int askCatDetail;    //질문 카테고리
...
public int getAskCatDetail() {
	return askCatDetail;
}

public void setAskCatDetail(int askCatDetail) {
