...
public class BoardController {
	...
	public String addGoods(@ModelAttribute("GoodsVO") GoodsVO goodsVO,
			HttpServletRequest request, ModelMap model) throws Exception {		
		
		return "/user/board/addGoods";
	}	
	
	@RequestMapping(value = "/addGoods/insert", method = RequestMethod.POST)
	@ResponseBody
	public String insertaddGoods(@ModelAttribute("GoodsVO") GoodsVO goodsVO,
			HttpServletRequest request, ModelMap model) throws Exception {
		
		goodsVO.setSellerName(EgovWebUtil.getUUID());
